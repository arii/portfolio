const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mermaid.core-DkPZ3Zm4.js","assets/index-0Z2DWVgR.js","assets/vendor-react-BD-e1e1Q.js","assets/index-C_n1pNxa.css","assets/svg-pan-zoom-Bed-R1tv.js"])))=>i.map(i=>d[i]);
import{r as sn,j as A,g as ro,R as Pn}from"./vendor-react-BD-e1e1Q.js";import{c as Ge,A as ha,G as oo,k as fa,l as pa,F as ma,C as ga,X as ya,S as er,m as ba,n as wa,o as ka,p as tr,q as xa,D as va,B as so,_ as nr}from"./index-0Z2DWVgR.js";import{E as ao,S as Sa}from"./Stack-BgTTusPE.js";import{r as nt}from"./asset-DoExnm4z.js";import{D as Aa}from"./download-CJm_gI9O.js";/**
...
`&&I!=="	"&&(f=m)}if(m>=u)if(f)c.push(f),u=f+l,f=void 0;else if(n===nn){for(;h===" "||h==="	";)h=v,v=e[m+=1],p=!0;const I=m>y+1?m-2:w-1;if(d[I])return e;c.push(I),d[I]=!0,u=I+l,f=void 0}else p=!0}h=v}if(p&&a&&a(),c.length===0)return e;s&&s();let g=e.slice(0,c[0]);for(let v=0;v<c.length;++v){const I=c[v],E=c[v+1]||e.length;I===0?g=`
...
`)y=w;else break}let g=n.substring(0,y<w?y+1:w);g&&(n=n.substring(g.length),g=g.replace(/\n+/g,`$&${c}`));let I=(m?c?"2":"1":"")+u;if(e&&(I+=" "+a(e.replace(/ ?[\r\n]+/g," ")),r&&r()),!d){const E=n.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let x=!1;const D=gn(i,!0);s!=="folded"&&t!==U.BLOCK_FOLDED&&(D.onOverflow=()=>{x=!0});const T=mn(`${g}${E}${h}`,c,ti,D);if(!x)return`>${I}
${c}${T}`}return n=n.replace(/\n+/g,`$&${c}`),`|${I}
${c}${g}${n}${h}`}function Tl(e,t,n,i){const{type:r,value:o}=e,{actualString:s,implicitKey:a,indent:l,indentStep:c,inFlow:d}=t;if(a&&o.includes(`
...
${s}
${c}
`}};function ut(e,{flow:t,indicator:n,next:i,offset:r,onError:o,parentIndent:s,startOnNewline:a}){let l=!1,c=a,d=a,u="",f="",h=!1,p=!1,m=null,w=null,y=null,g=null,v=null,I=null,E=null;for(const T of e)switch(p&&(T.type!=="space"&&T.type!=="newline"&&T.type!=="comma"&&o(T.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),p=!1),m&&(c&&T.type!=="comment"&&T.type!=="newline"&&o(m,"TAB_AS_INDENT","Tabs are not allowed as indentation"),m=null),T.type){case"space":!t&&(n!=="doc-start"||(i==null?void 0:i.type)!=="flow-collection")&&T.source.includes("	")&&(m=T),d=!0;break;case"comment":{d||o(T,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const L=T.source.substring(1)||" ";u?u+=f+L:u=L,f="",c=!1;break}case"newline":c?u?u+=T.source:(!I||n!=="seq-item-ind")&&(l=!0):f+=T.source,c=!0,h=!0,(w||y)&&(g=T),d=!0;break;case"anchor":w&&o(T,"MULTIPLE_ANCHORS","A node can have at most one anchor"),T.source.endsWith(":")&&o(T.offset+T.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),w=T,E??(E=T.offset),c=!1,d=!1,p=!0;break;case"tag":{y&&o(T,"MULTIPLE_TAGS","A node can have at most one tag"),y=T,E??(E=T.offset),c=!1,d=!1,p=!0;break}case n:(w||y)&&o(T,"BAD_PROP_ORDER",`Anchors and tags must be after the ${T.source} indicator`),I&&o(T,"UNEXPECTED_TOKEN",`Unexpected ${T.source} in ${t??"collection"}`),I=T,c=n==="seq-item-ind"||n==="explicit-key-ind",d=!1;break;case"comma":if(t){v&&o(T,"UNEXPECTED_TOKEN",`Unexpected , in ${t}`),v=T,c=!1,d=!1;break}default:o(T,"UNEXPECTED_TOKEN",`Unexpected ${T.type} token`),c=!1,d=!1}const x=e[e.length-1],D=x?x.offset+x.source.length:r;return p&&i&&i.type!=="space"&&i.type!=="newline"&&i.type!=="comma"&&(i.type!=="scalar"||i.source!=="")&&o(i.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),m&&(c&&m.indent<=s||(i==null?void 0:i.type)==="block-map"||(i==null?void 0:i.type)==="block-seq")&&o(m,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:v,found:I,spaceBefore:l,comment:u,hasNewline:h,anchor:w,tag:y,newlineAfterProp:g,end:D,start:E??D}}function Ot(e){if(!e)return null;switch(e.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(e.source.includes(`
`))return!0;if(e.end){for(const t of e.end)if(t.type==="newline")return!0}return!1;case"flow-collection":for(const t of e.items){for(const n of t.start)if(n.type==="newline")return!0;if(t.sep){for(const n of t.sep)if(n.type==="newline")return!0}if(Ot(t.key)||Ot(t.value))return!0}return!1;default:return!0}}function ri(e,t,n){if((t==null?void 0:t.type)==="flow-collection"){const i=t.end[0];i.indent===e&&(i.source==="]"||i.source==="}")&&Ot(t)&&n(i,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function $o(e,t,n){const{uniqueKeys:i}=e.options;if(i===!1)return!1;const r=typeof i=="function"?i:(o,s)=>o===s||Y(o)&&Y(s)&&o.value===s.value;return t.some(o=>r(o.key,n))}const ur="All mapping items must start at the same column";function Ql({composeNode:e,composeEmptyNode:t},n,i,r,o){var d;const s=(o==null?void 0:o.nodeClass)??ge,a=new s(n.schema);n.atRoot&&(n.atRoot=!1);let l=i.offset,c=null;for(const u of i.items){const{start:f,key:h,sep:p,value:m}=u,w=ut(f,{indicator:"explicit-key-ind",next:h??(p==null?void 0:p[0]),offset:l,onError:r,parentIndent:i.indent,startOnNewline:!0}),y=!w.found;if(y){if(h&&(h.type==="block-seq"?r(l,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in h&&h.indent!==i.indent&&r(l,"BAD_INDENT",ur)),!w.anchor&&!w.tag&&!p){c=w.end,w.comment&&(a.comment?a.comment+=`
`+w.comment:a.comment=w.comment);continue}(w.newlineAfterProp||Ot(h))&&r(h??f[f.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((d=w.found)==null?void 0:d.indent)!==i.indent&&r(l,"BAD_INDENT",ur);n.atKey=!0;const g=w.end,v=h?e(n,h,w,r):t(n,g,f,null,w,r);n.schema.compat&&ri(i.indent,h,r),n.atKey=!1,$o(n,a.items,v)&&r(g,"DUPLICATE_KEY","Map keys must be unique");const I=ut(p??[],{indicator:"map-value-ind",next:m,offset:v.range[2],onError:r,parentIndent:i.indent,startOnNewline:!h||h.type==="block-scalar"});if(l=I.end,I.found){y&&((m==null?void 0:m.type)==="block-map"&&!I.hasNewline&&r(l,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),n.options.strict&&w.start<I.found.offset-1024&&r(v.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const E=m?e(n,m,I,r):t(n,l,p,null,I,r);n.schema.compat&&ri(i.indent,m,r),l=E.range[2];const x=new ae(v,E);n.options.keepSourceTokens&&(x.srcToken=u),a.items.push(x)}else{y&&r(v.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),I.comment&&(v.comment?v.comment+=`
`+I.comment:v.comment=I.comment);const E=new ae(v);n.options.keepSourceTokens&&(E.srcToken=u),a.items.push(E)}}return c&&c<l&&r(c,"IMPOSSIBLE","Map comment with trailing content"),a.range=[i.offset,l,c??l],a}function Xl({composeNode:e,composeEmptyNode:t},n,i,r,o){const s=(o==null?void 0:o.nodeClass)??We,a=new s(n.schema);n.atRoot&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let l=i.offset,c=null;for(const{start:d,value:u}of i.items){const f=ut(d,{indicator:"seq-item-ind",next:u,offset:l,onError:r,parentIndent:i.indent,startOnNewline:!0});if(!f.found)if(f.anchor||f.tag||u)(u==null?void 0:u.type)==="block-seq"?r(f.end,"BAD_INDENT","All sequence items must start at the same column"):r(l,"MISSING_CHAR","Sequence item without - indicator");else{c=f.end,f.comment&&(a.comment=f.comment);continue}const h=u?e(n,u,f,r):t(n,f.end,d,null,f,r);n.schema.compat&&ri(i.indent,u,r),l=h.range[2],a.items.push(h)}return a.range=[i.offset,l,c??l],a}function Ut(e,t,n,i){let r="";if(e){let o=!1,s="";for(const a of e){const{source:l,type:c}=a;switch(c){case"space":o=!0;break;case"comment":{n&&!o&&i(a,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const d=l.substring(1)||" ";r?r+=s+d:r=d,s="";break}case"newline":r&&(s+=l),o=!0;break;default:i(a,"UNEXPECTED_TOKEN",`Unexpected ${c} at node end`)}t+=l.length}}return{comment:r,offset:t}}const _n="Block collections are not allowed within flow collections",Mn=e=>e&&(e.type==="block-map"||e.type==="block-seq");function Zl({composeNode:e,composeEmptyNode:t},n,i,r,o){var w;const s=i.start.source==="{",a=s?"flow map":"flow sequence",l=(o==null?void 0:o.nodeClass)??(s?ge:We),c=new l(n.schema);c.flow=!0;const d=n.atRoot;d&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let u=i.offset+i.start.source.length;for(let y=0;y<i.items.length;++y){const g=i.items[y],{start:v,key:I,sep:E,value:x}=g,D=ut(v,{flow:a,indicator:"explicit-key-ind",next:I??(E==null?void 0:E[0]),offset:u,onError:r,parentIndent:i.indent,startOnNewline:!1});if(!D.found){if(!D.anchor&&!D.tag&&!E&&!x){y===0&&D.comma?r(D.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${a}`):y<i.items.length-1&&r(D.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${a}`),D.comment&&(c.comment?c.comment+=`
`+D.comment:c.comment=D.comment),u=D.end;continue}!s&&n.options.strict&&Ot(I)&&r(I,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(y===0)D.comma&&r(D.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${a}`);else if(D.comma||r(D.start,"MISSING_CHAR",`Missing , between ${a} items`),D.comment){let T="";e:for(const L of v)switch(L.type){case"comma":case"space":break;case"comment":T=L.source.substring(1);break e;default:break e}if(T){let L=c.items[c.items.length-1];Z(L)&&(L=L.value??L.key),L.comment?L.comment+=`
`+T:L.comment=T,D.comment=D.comment.substring(T.length+1)}}if(!s&&!E&&!D.found){const T=x?e(n,x,D,r):t(n,D.end,E,null,D,r);c.items.push(T),u=T.range[2],Mn(x)&&r(T.range,"BLOCK_IN_FLOW",_n)}else{n.atKey=!0;const T=D.end,L=I?e(n,I,D,r):t(n,T,v,null,D,r);Mn(I)&&r(L.range,"BLOCK_IN_FLOW",_n),n.atKey=!1;const S=ut(E??[],{flow:a,indicator:"map-value-ind",next:x,offset:L.range[2],onError:r,parentIndent:i.indent,startOnNewline:!1});if(S.found){if(!s&&!D.found&&n.options.strict){if(E)for(const F of E){if(F===S.found)break;if(F.type==="newline"){r(F,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}D.start<S.found.offset-1024&&r(S.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else x&&("source"in x&&((w=x.source)==null?void 0:w[0])===":"?r(x,"MISSING_CHAR",`Missing space after : in ${a}`):r(S.start,"MISSING_CHAR",`Missing , or : between ${a} items`));const M=x?e(n,x,S,r):S.found?t(n,S.end,E,null,S,r):null;M?Mn(x)&&r(M.range,"BLOCK_IN_FLOW",_n):S.comment&&(L.comment?L.comment+=`
`+S.comment:L.comment=S.comment);const R=new ae(L,M);if(n.options.keepSourceTokens&&(R.srcToken=g),s){const F=c;$o(n,F.items,L)&&r(T,"DUPLICATE_KEY","Map keys must be unique"),F.items.push(R)}else{const F=new ge(n.schema);F.flow=!0,F.items.push(R);const N=(M??L).range;F.range=[L.range[0],N[1],N[2]],c.items.push(F)}u=M?M.range[2]:S.end}}const f=s?"}":"]",[h,...p]=i.end;let m=u;if((h==null?void 0:h.source)===f)m=h.offset+h.source.length;else{const y=a[0].toUpperCase()+a.substring(1),g=d?`${y} must end with a ${f}`:`${y} in block collection must be sufficiently indented and end with a ${f}`;r(u,d?"MISSING_CHAR":"BAD_INDENT",g),h&&h.source.length!==1&&p.unshift(h)}if(p.length>0){const y=Ut(p,m,n.options.strict,r);y.comment&&(c.comment?c.comment+=`
`+y.comment:c.comment=y.comment),c.range=[i.offset,m,y.offset]}else c.range=[i.offset,m,m];return c}function Rn(e,t,n,i,r,o){const s=n.type==="block-map"?Ql(e,t,n,i,o):n.type==="block-seq"?Xl(e,t,n,i,o):Zl(e,t,n,i,o),a=s.constructor;return r==="!"||r===a.tagName?(s.tag=a.tagName,s):(r&&(s.tag=r),s)}function ec(e,t,n,i,r){var f;const o=i.tag,s=o?t.directives.tagName(o.source,h=>r(o,"TAG_RESOLVE_FAILED",h)):null;if(n.type==="block-seq"){const{anchor:h,newlineAfterProp:p}=i,m=h&&o?h.offset>o.offset?h:o:h??o;m&&(!p||p.offset<m.offset)&&r(m,"MISSING_CHAR","Missing newline after block sequence props")}const a=n.type==="block-map"?"map":n.type==="block-seq"?"seq":n.start.source==="{"?"map":"seq";if(!o||!s||s==="!"||s===ge.tagName&&a==="map"||s===We.tagName&&a==="seq")return Rn(e,t,n,r,s);let l=t.schema.tags.find(h=>h.tag===s&&h.collection===a);if(!l){const h=t.schema.knownTags[s];if((h==null?void 0:h.collection)===a)t.schema.tags.push(Object.assign({},h,{default:!1})),l=h;else return h?r(o,"BAD_COLLECTION_TYPE",`${h.tag} used for ${a} collection, but expects ${h.collection??"scalar"}`,!0):r(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${s}`,!0),Rn(e,t,n,r,s)}const c=Rn(e,t,n,r,s,l),d=((f=l.resolve)==null?void 0:f.call(l,c,h=>r(o,"TAG_RESOLVE_FAILED",h),t.options))??c,u=X(d)?d:new U(d);return u.range=c.range,u.tag=s,l!=null&&l.format&&(u.format=l.format),u}function tc(e,t,n){const i=t.offset,r=nc(t,e.options.strict,n);if(!r)return{value:"",type:null,comment:"",range:[i,i,i]};const o=r.mode===">"?U.BLOCK_FOLDED:U.BLOCK_LITERAL,s=t.source?ic(t.source):[];let a=s.length;for(let m=s.length-1;m>=0;--m){const w=s[m][1];if(w===""||w==="\r")a=m;else break}if(a===0){const m=r.chomp==="+"&&s.length>0?`
`.repeat(Math.max(1,s.length-1)):"";let w=i+r.length;return t.source&&(w+=t.source.length),{value:m,type:o,comment:r.comment,range:[i,w,w]}}let l=t.indent+r.indent,c=t.offset+r.length,d=0;for(let m=0;m<a;++m){const[w,y]=s[m];if(y===""||y==="\r")r.indent===0&&w.length>l&&(l=w.length);else{w.length<l&&n(c+w.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),r.indent===0&&(l=w.length),d=m,l===0&&!e.atRoot&&n(c,"BAD_INDENT","Block scalar values in collections must be indented");break}c+=w.length+y.length+1}for(let m=s.length-1;m>=a;--m)s[m][0].length>l&&(a=m+1);let u="",f="",h=!1;for(let m=0;m<d;++m)u+=s[m][0].slice(l)+`
`;for(let m=d;m<a;++m){let[w,y]=s[m];c+=w.length+y.length+1;const g=y[y.length-1]==="\r";if(g&&(y=y.slice(0,-1)),y&&w.length<l){const I=`Block scalar lines must not be less indented than their ${r.indent?"explicit indentation indicator":"first line"}`;n(c-y.length-(g?2:1),"BAD_INDENT",I),w=""}o===U.BLOCK_LITERAL?(u+=f+w.slice(l)+y,f=`
`):w.length>l||y[0]==="	"?(f===" "?f=`
`:!h&&f===`
`&&(f=`
...
`&&(u+=`
`);break;default:u+=`
`}const p=i+r.length+t.source.length;return{value:u,type:o,comment:r.comment,range:[i,p,p]}}function nc({offset:e,props:t},n,i){if(t[0].type!=="block-scalar-header")return i(t[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:r}=t[0],o=r[0];let s=0,a="",l=-1;for(let f=1;f<r.length;++f){const h=r[f];if(!a&&(h==="-"||h==="+"))a=h;else{const p=Number(h);!s&&p?s=p:l===-1&&(l=e+f)}}l!==-1&&i(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${r}`);let c=!1,d="",u=r.length;for(let f=1;f<t.length;++f){const h=t[f];switch(h.type){case"space":c=!0;case"newline":u+=h.source.length;break;case"comment":n&&!c&&i(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=h.source.length,d=h.source.substring(1);break;case"error":i(h,"UNEXPECTED_TOKEN",h.message),u+=h.source.length;break;default:{const p=`Unexpected token in block scalar header: ${h.type}`;i(h,"UNEXPECTED_TOKEN",p);const m=h.source;m&&typeof m=="string"&&(u+=m.length)}}}return{mode:o,indent:s,chomp:a,comment:d,length:u}}function ic(e){const t=e.split(/\n( *)/),n=t[0],i=n.match(/^( *)/),o=[i!=null&&i[1]?[i[1],n.slice(i[1].length)]:["",n]];for(let s=1;s<t.length;s+=2)o.push([t[s],t[s+1]]);return o}function rc(e,t,n){const{offset:i,type:r,source:o,end:s}=e;let a,l;const c=(f,h,p)=>n(i+f,h,p);switch(r){case"scalar":a=U.PLAIN,l=oc(o,c);break;case"single-quoted-scalar":a=U.QUOTE_SINGLE,l=sc(o,c);break;case"double-quoted-scalar":a=U.QUOTE_DOUBLE,l=ac(o,c);break;default:return n(e,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${r}`),{value:"",type:null,comment:"",range:[i,i+o.length,i+o.length]}}const d=i+o.length,u=Ut(s,d,t,n);return{value:l,type:a,comment:u.comment,range:[i,d,u.offset]}}function oc(e,t){let n="";switch(e[0]){case"	":n="a tab character";break;case",":n="flow indicator character ,";break;case"%":n="directive indicator character %";break;case"|":case">":{n=`block scalar indicator ${e[0]}`;break}case"@":case"`":{n=`reserved character ${e[0]}`;break}}return n&&t(0,"BAD_SCALAR_START",`Plain value cannot start with ${n}`),Ho(e)}function sc(e,t){return(e[e.length-1]!=="'"||e.length===1)&&t(e.length,"MISSING_CHAR","Missing closing 'quote"),Ho(e.slice(1,-1)).replace(/''/g,"'")}function Ho(e){let t,n;try{t=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),n=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
