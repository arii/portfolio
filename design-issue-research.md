# Visual Defect & Design Improvement: Research

## Visual Defect Description
The current design aesthetics for `Research.tsx` rely on formulaic AI-generator boilerplate patterns that dilute the high-end engineering portfolio aesthetic.
Specifically:
...
## Validation Steps
1. Apply the new CSS rules and component structural changes in `src/pages/Research.tsx`.
