...
const ResearchCard: React.FC<ResearchCardProps> = ({ post, onSelect }) => {
  ...
  return (
    <article
      ...
      tabIndex={0}
      role="button"
      className="group flex flex-col justify-between rounded-xl border border-slate-800 bg-brand-bg-surface/30 p-6 transition-all hover:border-brand-green/50 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-green cursor-pointer"
    >
      <div>
