...
export const publicationsData: ResumePublication[] = [
  ...
  },
  {
    ...
    category: 'journal_conference',
    link: 'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=NM6SfiEAAAAJ&citation_for_view=NM6SfiEAAAAJ:IjCSPb-OGe4C'
  },
  {
  ...
  {
    id: 'oracle-simd-2012',
    title: 'Improving Oracle Number Arithmetic with SIMD/SSE Vectorization',
    type: 'Database Capstone',
    year: '2012',
    authors: ['B. Gold', 'A. Anders', 'L. Thurlow', 'N. Pemberton'],
    venue: 'Oracle Database Engineering Capstone (UC Santa Cruz)',
    category: 'symposium_other',
    link: 'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=NM6SfiEAAAAJ&citation_for_view=NM6SfiEAAAAJ:u5HHmVD_uO8C'
  }
];
