...
export const FOCUS_CARDS: FocusCardData[] = [
  {
    ...
    desc: "Live consumer applications, fitness trackers, and full-stack community platforms built via AI orchestration.",
  ...
  },
  {
    ...
    desc: "Deep dives into active tooling: autonomous code review agents, CI pipelines, and strict quality gates.",
  ...
  },
  {
    ...
    desc: "Technical essays, system architecture breakdowns, and post-mortems on migrating production systems.",
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    items: ["C++17/20", "Python", "ROS 2", "Behavior Trees", "State Estimation", "Motion Planning"]
  },
  {
    category: "DevAI & Infrastructure",
    items: ["Docker", "AWS IoT", "TypeScript", "GitHub Actions", "Playwright", "Agentic CI/CD"]
  }
];
