...
export const flagshipTools: ResearchTool[] = [
  {
    ...
    description: "Real-time Web Bluetooth HR telemetry synchronized across multi-client workout sessions via WebSockets, with dynamic zone calculation, Spotify Web Playback SDK automation, and workout analytics. Originally prototyped during 2020 remote training, HRM's v2 rewrite served as the foundational testbed for building RepoAuditor and autonomous CI/CD PR review guardrails.",
