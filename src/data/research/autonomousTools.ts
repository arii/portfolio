...
export const autonomousTools: ResearchTool[] = [
  {
    ...
    description: 'I contributed to an open-source, low-cost robotics education and research platform for autonomous driving, multi-agent fleet coordination, and lane tracking for rubber ducks.',
  ...
  },
  {
    ...
    description: 'I led instruction and developed curricula for autonomous miniature racecars utilizing visual servoing, motion planning, and ROS.',
    category: 'Education',
    status: 'Completed',
  ...
  },
  {
    ...
    description: 'I deployed a decentralized multi-agent package delivery system in dynamic human environments (RSS 2015 Best Paper Finalist & IJRR journal publication).',
    category: 'Robotics & Autonomy',
    status: 'Completed',
  ...
  },
  {
    ...
    description: 'I developed an iOS app for blind and visually impaired users to detect light levels (from daylight to router indicators) and interpret values through sound.',
    category: 'Software',
    status: 'Completed',
  ...
  },
  {
    ...
    description: 'I implemented robotic trajectory planning, 6-DOF manipulation, and dynamic registration for autonomous dental crowning with Dr. Jacob Rosen.',
