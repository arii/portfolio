        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {engineeringTools.map(tool => {
              const handleClick = () => {
                if (tool.id === 'ux-auditor') {
                  onNavigate('deployment-impact-analyzer');
              ...
              return (
                <div
                  key={tool.id}
                  onClick={handleClick}
                  className="p-4 bg-surface/50 border border-line rounded-2xl hover:border-accent hover:shadow-glow transition-all space-y-2 cursor-pointer text-left"
                >
