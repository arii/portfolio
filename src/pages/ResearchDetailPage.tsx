...
const MermaidDiagram: React.FC<{ chart: string }> = ({ chart }) => {
  ...
  return (
    <div
      className="my-8 rounded-2xl border border-line bg-surface p-4 sm:p-6 overflow-x-auto flex justify-center mermaid-container [&>svg]:min-w-[700px] [&>svg]:w-full"
      // SVG content is generated by mermaid.render from local, trusted markdown definitions
